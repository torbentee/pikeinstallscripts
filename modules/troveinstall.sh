...
systemctl stop trove-taskmanager >/dev/null 2>&1
systemctl stop trove-taskmanager >/dev/null 2>&1
systemctl stop trove-api >/dev/null 2>&1
systemctl stop trove-api >/dev/null 2>&1
systemctl stop trove-conductor >/dev/null 2>&1
systemctl stop trove-conductor >/dev/null 2>&1
...
systemctl start trove-api
systemctl start trove-taskmanager
systemctl start trove-conductor
